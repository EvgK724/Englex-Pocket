...
export const FISH_PROFILES = [
  ...
  {uri:FISH_ENGLISH_VOICE_URI,label:'Чонишвили · английская проба',manifest:'fish-chonishvili-en-gb-v1-index.json',directory:'audio/fish-chonishvili-en-gb-v1',profile:'en-gb-v1',version:'recover-phonemes-2'}
];
